...
export class HistoryComponent {
  ...
  januaryExpense: any[] = [
    ...
    { expenseType: "Factures d'électricité", expenseAmount: 500 },
  ];
  februaryExpense: any[] = [
    { expenseType: 'Essentiels', expenseAmount: 200 },
    { expenseType: "Factures d'électricité", expenseAmount: 400 }
  ];
  marchExpense: any[] = [
    { expenseType: 'Recharge', expenseAmount: 1100 },
    { expenseType: 'Essentiels', expenseAmount: 250 }
  ];
